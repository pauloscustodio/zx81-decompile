...
ROTATE_SHIP:
        ld de, $0019            ; 5*5=25 bytes per ship
...
store_count:
        ld (rotate_count), a
        ld hl, $4546            ; address of ship1-25 bytes
        ld b, a
...
INTRO_FIRE_TORPEDO:
        ...
        ld hl, $45FB            ; reached start, go back to end
...
TEST_KEYBOARD:
        call KEYBOARD           ; scan keyboard, H=column, L=half-row
        ld bc, (ship_col)
        ld (pressed_key), hl
        ld de, $FFFF
        and a
